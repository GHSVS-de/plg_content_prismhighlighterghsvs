<?php
/**
 * @package plugin.content prismhighlighterghsvs for Joomla!
 * @version See prismhighlighterghsvs.xml
...
class plgContentPrismHighlighterGhsvsInstallerScript extends InstallerScript
{
	...
	protected $deleteFiles = [
		// Force renewal even if renewal.log is also set to 0.
		'/media/plg_content_prismhighlighterghsvs/json/aliasLanguageMap.json',
		'/media/plg_content_prismhighlighterghsvs/json/pluginCssMapJson.json',
	];
