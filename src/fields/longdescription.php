...
<field name="LongDescription001"
		type="plgContentPrismHighlighterGhsvs.longdescription" // Mandatory.
...
class plgContentPrismHighlighterGhsvsFormFieldLongDescription extends FormField
{
	protected $type = 'longdesription';

	protected $renderLayout = 'ghsvs.renderfield';

	protected $myLayoutPath = 'plugins/content/prismhighlighterghsvs/layouts';

	protected $myLanguagePath = 'plugins/content/prismhighlighterghsvs/language';
